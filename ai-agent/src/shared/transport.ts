// VENDORED COPY of /shared/transport.ts — kept inside the agent package so it
// deploys as a self-contained subdirectory (Node can't resolve ../../shared at
// runtime when only ai-agent/ is shipped). This is the realtime wire protocol
// shared with the frontend: if you change /shared/transport.ts, mirror it here
// or collaboration between the agent and browser clients will break.
